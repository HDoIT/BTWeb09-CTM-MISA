...
.mi-sort-down{
    background-position: -891px -359px;
	width: 28px;
	height: 18px;
}
.mi-sort-down-cbb{
    background-position: -1743px -301px;
}
/* input */
/* combobox */
...
.mi-icon-salary{
    background-position: -296px -1662px;
	width: 14px;
	height: 18px;
}
...
.mi-search:hover{
    background-position: -956px -31px;
}
...
.mi-null{
    background-position: -1230px -638px;
	width: 120px;
	height: 66px;
}

.mi-navbar-icon-white{
